...
struct dvfs_hw_callback {
	int (*hw_check_and_vote)(unsigned int target_freq);
...
struct governor_callback {
	...
	int (*get_mask_freq_table)(unsigned int *data, unsigned int sel);
	int (*set_mask_freq_table)(unsigned int target_freq, bool is_mask);
