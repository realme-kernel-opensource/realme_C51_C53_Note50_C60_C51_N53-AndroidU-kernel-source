...
int hl7138_reset_voocphy(struct oplus_voocphy_manager *chip)
{
	...
	hl7138_write_byte(chip->client, HL7138_REG_11, 0xFC);	/* JL:Dis VBAT,IBAT reg,VBAT OVP threshold = bit(5:4) + VBAT_REG; */
	hl7138_write_byte(chip->client, HL7138_REG_08, 0x3C);	/* JL:VBAT_REG: VBAT_REG_TH (V) = 4.0V + bit(5:0) * 10mV; */
...
static int hl7138_init_device(struct oplus_voocphy_manager *chip)
{
	...
	hl7138_write_byte(chip->client, HL7138_REG_11, 0xFC);	/* ovp:110mV */
	hl7138_write_byte(chip->client, HL7138_REG_08, 0x3C);	/* VBAT_OVP:4.6	4.6+0.11*/
