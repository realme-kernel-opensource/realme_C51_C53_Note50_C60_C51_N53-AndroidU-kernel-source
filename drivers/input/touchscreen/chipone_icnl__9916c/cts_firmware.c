        ...
        u32 hwid, u16 fwid, u16 curr_firmware_ver)
{
    ...
    if (g_firmware_version_cts == 0) {
        ...
        firmware_filename = CFG_CTS_FIRMWARE_FILENAME_CD;
        firmware_filepath = CFG_CTS_FIRMWARE_FILEPATH_CD;
    } else  if (g_firmware_version_cts == 10) {
        firmware_filename = CFG_CTS_FIRMWARE_FILENAMEK;
        firmware_filepath = CFG_CTS_FIRMWARE_FILEPATHK;
    } else  if (g_firmware_version_cts == 11) {
        firmware_filename = CFG_CTS_FIRMWARE_FILENAME_INXK;
        firmware_filepath = CFG_CTS_FIRMWARE_FILEPATH_INXK;
    }
#ifdef CFG_CTS_FIRMWARE_IN_FS
