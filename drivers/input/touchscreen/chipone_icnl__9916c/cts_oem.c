...
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN_INX      1100
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX_INX      2900
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_INX        120
#define OEM_OF_DEF_PROPVAL_OPEN_MIN_INX         1600
#define OEM_OF_DEF_PROPVAL_SHORT_MIN_INX        1600
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_INX     1
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_INX     127
/* for INX version end*/

/*for 10W (hulk k/M)INX version start*/
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_INX_10W        110
/*for 10W (hulk k/M)INX version end*/
...
/* for INX version start*/
#define OEM_OF_DEF_PROPVAL_GESTURE_RAWDATA_MIN_INX        1800
#define OEM_OF_DEF_PROPVAL_GESTURE_RAWDATA_MAX_INX        5400
#define OEM_OF_DEF_PROPVAL_GESTURE_LP_RAWDATA_MIN_INX     1800
#define OEM_OF_DEF_PROPVAL_GESTURE_LP_RAWDATA_MAX_INX     5400
#define OEM_OF_DEF_PROPVAL_GESTURE_NOISE_MAX_INX          120
#define OEM_OF_DEF_PROPVAL_GESTURE_LP_NOISE_MAX_INX       120
/* for INX version end*/
#endif
...
#define OEM_EDGE_SWITCH_PROC_FILENAME          "oppo_tp_direction"
    ...
    struct device_node *np)
{
    ...
    if (oem_data->test_noise) {
        ...
        if (g_firmware_version_cts == 1) {
            ...
            oem_data->noise_max = OEM_OF_DEF_PROPVAL_NOISE_MAX_INX_10W;
        }
        if (ret) {
	...
	size_t size, loff_t *ppos)
{
	...
	cts_info("Read oppo_tp_direction ");
