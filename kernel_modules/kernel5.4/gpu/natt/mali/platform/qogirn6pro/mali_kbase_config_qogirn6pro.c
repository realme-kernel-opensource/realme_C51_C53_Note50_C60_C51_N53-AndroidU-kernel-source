...
static int gpu_pmic_get_regmap(void)
{
...
static inline void mali_freq_init(struct device *dev)
{
	...
	ret = gpu_pmic_get_regmap();//write real pmic syscon
	if(ret)pr_err("pmic get regmap error %d!",ret);
	...
	if (!strcmp(gpu_dvfs_ctx.auto_efuse, "T760") || !strcmp(gpu_dvfs_ctx.auto_efuse, "T157"))
	{
		//modify 680M to 650M
...
static inline void mali_clock_on(void)
{
	...
	if (!strcmp(gpu_dvfs_ctx.auto_efuse, "T760") || !strcmp(gpu_dvfs_ctx.auto_efuse, "UTS6560") || !strcmp(gpu_dvfs_ctx.auto_efuse, "T157"))
	{
...
{
	int min_index, max_index, modify_flag = 0;
