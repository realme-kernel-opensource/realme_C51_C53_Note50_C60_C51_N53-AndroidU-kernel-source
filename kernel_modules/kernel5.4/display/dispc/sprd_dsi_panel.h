...
enum {
	...
	CMD_CODE_RESERVED4,
	CMD_CODE_RESERVED5,
	/* xiazhiping@MULTIMEDIA.DISPLAY.LCD  2023/01/30 add cabc func  start*/
	CMD_CODE_CABC_OFF,
	CMD_CODE_CABC_UI,
	CMD_CODE_CABC_STILL,
	CMD_CODE_CABC_MOVING,
	/* xiazhiping@MULTIMEDIA.DISPLAY.LCD  2023/01/30 add cabc func  end*/
...
struct panel_info {
	...
	u32 dual_dsi_en;
	u32 cabc_mode;
    /* maohesong@MULTIMEDIA.DISPLAY.LCD, 2024/1/26, add for pre_avdd_rst_on_seq reset_sequence */
	u32 ft8057_sequence_enable;
